    ...
    <style>
        * {
        ...
        @keyframes logoPulse {
            ...
            0%,
            100% {
                box-shadow: 0 15px 30px rgba(59, 158, 255, 0.6);
            }

            50% {
                box-shadow: 0 25px 50px rgba(59, 158, 255, 0.9);
            }
        }
        ...
        /* أيقونة داخل الحقل (يمكن إضافتها عبر background-image) */
        .input-icon {
            position: relative;
        }
        ...
        /* رسالة الحالة (مثل بعد تسجيل الخروج) */
        .session-status {
            background: rgba(59, 158, 255, 0.15);
...
<body>
    ...
    <div class="particles">
        ...
        <div class="particle"
            style="width: 200px; height: 200px; bottom: 15%; right: 10%; background: rgba(106, 212, 180, 0.1);"></div>
        <div class="particle" style="width: 150px; height: 150px; top: 40%; right: 20%;"></div>
        <div class="particle"
            style="width: 250px; height: 250px; bottom: 30%; left: 15%; background: rgba(106, 212, 180, 0.1);"></div>
    </div>
    ...
    <div class="login-container">
        <div class="glass-card">
            ...
            <!-- Session Status (مثل رسالة تأكيد تسجيل الخروج) -->
            @if (session('status'))
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="input-group input-icon email">
                    ...
                    <input id="email" type="email" name="email" value="{{ old('email') }}" required autofocus
                        autocomplete="username" placeholder="your@email.com" class="input-field">
                    @error('email')
    ...
    <!-- تأثيرات JavaScript بسيطة لتحسين التجربة -->
    <script>
        (function() {
